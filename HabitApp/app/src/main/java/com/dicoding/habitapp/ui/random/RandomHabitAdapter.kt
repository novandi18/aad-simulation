...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvMinutes: TextView = itemView.findViewById(R.id.pager_tv_start_time)
        private val tvMinutesFocus: TextView = itemView.findViewById(R.id.pager_tv_minutes)
        private val ivPriorityLevel: ImageView = itemView.findViewById(R.id.item_priority_level)
        private val btnOpenCount: Button = itemView.findViewById(R.id.btn_open_count_down)

        fun bind(pageType: PageType, pageData: Habit) {
            tvTitle.text = pageData.title
            tvMinutes.text = pageData.startTime
            tvMinutesFocus.text = pageData.minutesFocus.toString()
            when (pageType) {
                PageType.HIGH -> {
                    ivPriorityLevel.setImageDrawable(
