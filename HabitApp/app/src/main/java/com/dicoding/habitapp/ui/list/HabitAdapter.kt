...
class HabitAdapter(
    ...
    override fun onBindViewHolder(holder: HabitViewHolder, position: Int) {
        ...
        when (habit.priorityLevel) {
            holder.itemView.context.resources.getStringArray(R.array.priority_level)[0] -> {
                holder.ivPriority.setImageDrawable(
                    ContextCompat.getDrawable(holder.itemView.context, R.drawable.ic_priority_high)
                )
            }
            holder.itemView.context.resources.getStringArray(R.array.priority_level)[1] -> {
                holder.ivPriority.setImageDrawable(
                    ContextCompat.getDrawable(holder.itemView.context, R.drawable.ic_priority_medium)
                )
            }
            holder.itemView.context.resources.getStringArray(R.array.priority_level)[2] -> {
                holder.ivPriority.setImageDrawable(
                    ContextCompat.getDrawable(holder.itemView.context, R.drawable.ic_priority_low)
                )
            }
        }
    }
